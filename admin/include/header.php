                ...
                <ul class="metismenu" id="menu">
                   <br> <br>       
                    ...
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="fa fa-address-card-o menu-icon"></i><span class="nav-text">Faculty</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./add-employee.php"> <i class="icon-plus menu-icon"></i><span class="nav-text">Add Faculty</span></a></li>
                            <li><a href="./manage-employee.php"> <i class="fa fa-tasks menu-icon"></i><span class="nav-text">Manage Faculty</span></a></li>
                    ...
                    <li>
                        <a href="./manage-leave.php" >
                            <i class="fa fa-tasks menu-icon"></i><span class="nav-text">Manage Faculty Leave</span>
                        </a>
                    </li>
                    <li>
                        <a href="./logout.php" >
